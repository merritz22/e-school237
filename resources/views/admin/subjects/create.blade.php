...
@section('title', 'Créer un sujet d\'évaluation')
...
<div class="bg-white p-5 max-w-3xl mx-auto">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Créer un sujet d'évaluation</h1>
            <p class="text-gray-600 mt-1">Remplissez le formulaire pour ajouter un nouveau sujet</p>
        </div>
    ...
    <!-- Formulaire -->
    <form action="{{ route('admin.subjects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4" 
                      ...
                      placeholder="Description ou notes supplémentaires">{{ old('description') }}</textarea>
