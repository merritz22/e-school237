...
<div class="bg-white p-5">
    ...
    <div class="border-b border-gray-200 pb-4 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Ajouter une matière</h1>
                <p class="text-gray-600 mt-1">Enregistrer nouvelle une matière</p>
            </div>
    ...
    <form action="{{ route('admin.topics.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="p-6">
            @component('admin.topics.form', ['topic' => null])
            @endcomponent
        </div>
