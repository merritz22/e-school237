...
Dans la section profile, prévoir
    Renseigner les informations suivante stockée dans user_informations:
        ...
        =>Sélectionner parmis les matières de sa classe celle ou il s'en sort le mieux,
        =>Sélectionner parmis les matières de sa classe celle ou il s'en sort le moins,
